    ...
    let posts = [
{
    ...
    likes: 12,
    comments: [
{user: "Margaret", text: "The locket discovery is fascinating! Any updates on identifying the photographs?", date: "June 14, 2023"},
{user: "Charles", text: "What technique did you use to clean it without damaging the piece?", date: "June 13, 2023"}
    ]
},
{
    id: 2,
    ...
    likes: 8,
    comments: [
{user: "AntiqueLover", text: "Amazing work! How long did the restoration process take?", date: "May 30, 2023"}
    ]
}
    ];
